...
def show_projects_section():
    ...
    if language == "Türkçe":
        ...
        components.iframe(
            f"https://docs.google.com/gview?url=https://github.com/EdaCelikeloglu/streamlit_portfolyo/blob/master/assets/Eda_Celikeloglu_Sales_Summaries.pdf&embedded=true",
            height=600)
        st.download_button(
            label="📥 PDF İndir",
            data=pdf_bytes,
